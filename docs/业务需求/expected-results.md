...
- 本文只覆盖 `2026-04-01 ~ 2026-04-07` 的**最小回归窗口**
- 04-08+ 扩展渠道层、04-15+ 高频批量层的对账口径，单独放在 `docs/业务需求/extended-seed-results.md`
...
- **扩展种子完整性回归**：见 `extended-seed-results.md`
- **Excel 全场景补充用例**：见 `第一期需求全覆盖补充用例.md` 与 `csv/12_第一期全覆盖增量用例.csv`
- **普通问数补充用例**：见 `普通问数补充用例.md` 与 `csv/13_普通问数补充用例.csv`
- **仍不在本轮回归范围**：T05 / T14 / T15
  - T05 / T14：缺投放金额
  - T15：缺 PV / UV / 下载点击 UV
