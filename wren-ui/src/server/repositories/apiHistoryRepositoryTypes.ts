...
export enum ApiType {
  ...
  GET_BUSINESS_TERMS = 'GET_BUSINESS_TERMS',
  CREATE_BUSINESS_TERM = 'CREATE_BUSINESS_TERM',
  UPDATE_BUSINESS_TERM = 'UPDATE_BUSINESS_TERM',
  DELETE_BUSINESS_TERM = 'DELETE_BUSINESS_TERM',
  GET_EXTERNAL_DEPENDENCIES = 'GET_EXTERNAL_DEPENDENCIES',
  CREATE_EXTERNAL_DEPENDENCY = 'CREATE_EXTERNAL_DEPENDENCY',
  UPDATE_EXTERNAL_DEPENDENCY = 'UPDATE_EXTERNAL_DEPENDENCY',
  DELETE_EXTERNAL_DEPENDENCY = 'DELETE_EXTERNAL_DEPENDENCY',
