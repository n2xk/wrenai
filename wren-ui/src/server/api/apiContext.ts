...
export const buildApiContextFromRequest = async ({
  ...
  return {
    ...
    spreadsheetService: components.spreadsheetService,
    threadResponseFeedbackService: components.threadResponseFeedbackService,
    ...
    spreadsheetRepository: components.spreadsheetRepository,
    spreadsheetSettingRepository: components.spreadsheetSettingRepository,
    spreadsheetHistoryRepository: components.spreadsheetHistoryRepository,
    threadResponseFeedbackRepository:
      components.threadResponseFeedbackRepository,
